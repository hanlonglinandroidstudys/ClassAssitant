...
import hanlonglin.com.teacher_model.activitys.TeaCheckAttendActivity;
import hanlonglin.com.teacher_model.adapter.StudentRecyclerAdapter;

public class TeaFgCallStudents extends BaseFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = LayoutInflater.from(getActivity()).inflate(R.layout.tea_fg_callstudents, container, false);
        initView(v);
        return v;
    }
    ...
    private void showStudents() {
        ...
        studentRecyclerAdapter.setOnChooseStuListener(new StudentRecyclerAdapter.OnChooseStuListener() {
            ...
            public void onItemClick(Student stu) {
                //进入点名界面
                TeaCheckAttendActivity.actionStart(stu.getSid(),getActivity());
            }
        });
